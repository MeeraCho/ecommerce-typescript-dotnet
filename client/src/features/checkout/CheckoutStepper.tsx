import { Box, Button, Checkbox, FormControlLabel, Typography, Paper, Step, StepLabel, Stepper } from "@mui/material";
...
export default function CheckoutStepper() {
    ...
    const handleNext = async () => {
        ...
        if (activeStep === 1) {
            ...
            //Before confirming payment, validate the state of the Payment Element and collect any data required for wallets
